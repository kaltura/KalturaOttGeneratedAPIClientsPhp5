 ...
 * @subpackage Client
 */
class KalturaCaptionUploadData extends KalturaObjectBase
{
	/**
 ...
 * @subpackage Client
 */
class KalturaCaptionUploadJob extends KalturaObjectBase
{
	/**
	 * Id
	 *
 ...
 * @subpackage Client
 */
class KalturaEnrichedMetadataResult extends KalturaObjectBase
{
	/**
	 * A dictionary holding the names and values of the generated metadata.
	 *             key - the metadata name/key, e.g. ‘Genre’, ‘shortDescription’ etc.
 ...
 * @subpackage Client
 */
class KalturaMetaEnrichConfiguration extends KalturaObjectBase
{
	/**
	 * Specifies if the feature is enabled or disabled.
	 *
